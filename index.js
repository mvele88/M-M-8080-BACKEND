...
app.post('/report-actual-profit', async (req, res) => {
  initFirebaseAdmin(); // Ensure Firebase is initialized
  if (!db) {
    return res.status(500).json({ error: 'Firestore not initialized. FIREBASE_SERVICE_ACCOUNT_KEY might be invalid or missing.' основных. });
  }
...
>>>>>>> 9168e7e (Initial commit of local backend project files, including index.